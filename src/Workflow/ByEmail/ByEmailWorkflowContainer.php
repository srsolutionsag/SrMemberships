...
namespace srag\Plugins\SrMemberships\Workflow\ByEmail;
...
use srag\Plugins\SrMemberships\Workflow\ByEmail\Action\ByEmailActionHandler;

/**
 * @author Fabian Schmid <fabian@sr.solutions>
 */
class ByEmailWorkflowContainer extends AbstractBaseWorkflowContainer
{
    ...
    {
        return $this->container->config()->byEmail();
    }

    public function isToolAvailable(Context $context): bool
    {
        // depends on settings
        $offered_to = $this->getConfig()->get(ByEmailConfig::F_OFFER_WORKFLOW_TO) ?? [];
    ...
    {
        return new \ilSrMsByEmailConfigurationGUI();
    }
    ...
    {
        return new ByEmailWorkflowToolConfigFormProvider(
            $this->container,
            $this
        );
    }
    ...
    {
        return new ByEmailActionHandler($this->container);
    }
}
