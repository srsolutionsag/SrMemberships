...
namespace srag\Plugins\SrMemberships\Workflow\ByEmail\Action;
 ...
 */
class ByEmailActionHandler extends AbstractByStringActionHandler
{
    public function getPersonList(string $text, ?string $original_mime_type = null): PersonList
    {
        return $this->person_list_generators->byEmailsFromString(
            $text,
            $original_mime_type
        );
    }
